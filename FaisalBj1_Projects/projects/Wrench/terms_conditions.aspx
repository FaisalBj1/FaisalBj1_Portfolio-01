<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="terms_conditions.aspx.cs" Inherits="Wrench.terms_conditions" %>
...
<head runat="server">
    ...
    <body style="width:89%;">
        ...
        <h1 style="font-family:'Times New Roman', Times, serif; font-size:19pt; text-align:center;">Terms & Conditions EXAMPLE</h1>
        <br />
        <br />
        <br />

        <h2 style="font-family:Arial, Helvetica, sans-serif; font-size:11pt;">AGREEMENT TO TERMS</h2>
